...
(module
    ...
    (import "clarity" "contract_call" (func $contract_call (param $contract_id_offset i32)
                                                           ...
                                                           (param $return_offset i32)
                                                           (param $return_length i32)))
    (import "clarity" "keccak256" (func $keccak256 (param $buffer_offset i32)
                                                   (param $buffer_length i32)
                                                   (param $result_offset i32)
                                                   (param $result_length i32)
                                                   (result i32 i32)))
    (import "clarity" "sha512" (func $sha512 (param $buffer_offset i32)
                                             (param $buffer_length i32)
                                             (param $result_offset i32)
                                             (param $result_length i32)
                                             (result i32 i32)))
    (import "clarity" "sha512_256" (func $sha512_256 (param $buffer_offset i32)
                                                     (param $buffer_length i32)
                                                     (param $result_offset i32)
                                                     (param $result_length i32)
                                                     (result i32 i32)))
    (import "clarity" "secp256k1_recover" (func $secp256k1_recover (param $msg_offset i32)
                                                                   (param $msg_length i32)
                                                                   (param $sig_offset i32)
                                                                   (param $sig_length i32)
                                                                   (param $result_offset i32)
                                                                   (param $result_length i32)))
    (import "clarity" "secp256k1_verify" (func $secp256k1_verify (param $msg_offset i32)
                                                                 (param $msg_length i32)
                                                                 (param $sig_offset i32)
                                                                 (param $sig_length i32)
                                                                 (param $pk_offset i32)
