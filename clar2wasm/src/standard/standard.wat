...
(module
    ...
    (func $stdlib.sub-int (param $b_lo i64) (param $b_hi i64) (param $a_lo i64) (param $a_hi i64) (result i64 i64)
        (local $diff_hi i64)
        (local $diff_lo i64)
    ...
    (func $stdlib.sub-uint (param $b_lo i64) (param $b_hi i64) (param $a_lo i64) (param $a_hi i64) (result i64 i64)
        (local $diff_hi i64)
        (local $diff_lo i64)
    ...
    (func $stdlib.div-int128 (param $divisor_lo i64) (param $divisor_hi i64) (param $dividend_lo i64) (param $dividend_hi i64) (result i64 i64 i64 i64)
    ...
    (func $stdlib.div-uint (param $divisor_lo i64) (param $divisor_hi i64) (param $dividend_lo i64) (param $dividend_hi i64) (result i64 i64)
        (local $quotient_hi i64)
        (local $quotient_lo i64)
        (local $remainder_hi i64)
        (local $remainder_lo i64)

        (call $stdlib.div-int128 (local.get $divisor_lo) (local.get $divisor_hi) (local.get $dividend_lo) (local.get $dividend_hi))
        (local.set $remainder_hi)
        (local.set $remainder_lo)
