...
impl SimpleWord for BitwiseNot {
    ...
    fn visit(
        ...
        generator.cost_bitwise_not(builder);
...
impl SimpleWord for BitwiseOr {
    ...
    fn visit(
        ...
        generator.cost_bitwise_or(builder, arg_types.len() as _);
...
impl SimpleWord for BitwiseAnd {
    ...
    fn visit(
        ...
        generator.cost_bitwise_and(builder, arg_types.len() as _);
...
impl SimpleWord for BitwiseXor {
    ...
    fn visit(
        ...
        generator.cost_bitwise_xor(builder, arg_types.len() as _);
...
impl SimpleWord for BitwiseLShift {
    ...
    fn visit(
        ...
        generator.cost_bitwise_lshift(builder);
        builder.call(func);
        Ok(())
    }
}
...
impl SimpleWord for BitwiseRShift {
    ...
    fn visit(
        ...
        generator.cost_bitwise_rshift(builder);
        builder.call(helper);
