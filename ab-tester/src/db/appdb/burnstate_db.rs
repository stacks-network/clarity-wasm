...
use crate::{clarity, stacks, db::schema::appdb::*, db::model::app_db::*};
use super::AppDb;
...
impl clarity::BurnStateDB for AppDbBurnStateWrapper {
    ...
    fn get_burn_header_hash(
        ...
        _snapshots::table
            ...
            .expect("failed to execute database query")
            .map(|hash: Vec<u8>| {
                stacks::BurnchainHeaderHash(hash.try_into()
    ...
    fn get_sortition_id_from_consensus_hash(
        ...
        _snapshots::table
            ...
            .expect("failed to execute database query")
            .map(|bytes: Vec<u8>| {
                stacks::SortitionId(bytes.try_into()
    ...
    fn get_stacks_epoch_by_epoch_id(
        ...
        epoch.map(|e| e.try_into().expect("failed to convert epoch into clarity StacksEpoch"))
    }
