...
use diesel::{insert_into, prelude::*, OptionalExtension, SqliteConnection, QueryDsl};
...
use crate::{
    ...
    db::{
        model::app_db::{
            ...
            Environment, Payment, MaturedReward
        },
        schema::appdb::*,
    },
    stacks::{self, Address}
...
impl clarity::HeadersDB for AppDb {
    ...
    fn get_stacks_block_header_hash_for_block(
        ...
        self.get_block_header_by_stacks_block_id(id_bhh)
            .unwrap()
            .map(|header| stacks::BlockHeaderHash(
                header
                    .index_block_hash
                    .try_into()
    ...
    fn get_burn_header_hash_for_block(
        ...
        self.get_block_header_by_stacks_block_id(id_bhh)
            .unwrap()
            .map(|header| stacks::BurnchainHeaderHash(
                header
                    .burn_header_hash
                    .try_into()
    ...
    fn get_consensus_hash_for_block(
        ...
        self.get_block_header_by_stacks_block_id(id_bhh)
            .unwrap()
            .map(|header| stacks::ConsensusHash(
                header
                    .consensus_hash
                    .try_into()
    ...
    fn get_miner_address(
        ...
        self.get_payment_by_stacks_block_id(id_bhh)
            .unwrap()
            .map(|payment| stacks::Address::from_string(&payment.address)
    ...
    fn get_tokens_earned_for_block(
        ...
        let parent_id_bhh = self.get_block_header_by_stacks_block_id(child_id_bhh)
            .unwrap()
        ...
        let rewards = _matured_rewards::table
            .filter(
                _matured_rewards::parent_index_block_hash.eq(parent_id_bhh)
        ...
        } else if child_id_bhh == &stacks::StacksBlockHeader::make_index_block_hash(
