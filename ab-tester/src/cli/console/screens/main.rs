...
use ratatui::prelude::{Layout, Constraint};

use crate::cli::console::components::{Component, Header, Menu, StatusBar, Empty};
...
impl<'a> Component for MainLayout<'a> {
    fn draw(&mut self, f: &mut crate::cli::console::tui::Frame<'_>, area: ratatui::prelude::Rect, theme: &crate::cli::console::theme::Theme) -> color_eyre::eyre::Result<()> {
